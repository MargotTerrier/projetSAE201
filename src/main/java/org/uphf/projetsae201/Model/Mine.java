...
public class Mine extends District{
    ...
    public int extraction(Robot r){ // retourne le nombre de minerais qui sera extrait
        if (this.nbMinerais == 0) return -1; // Si la mine est vide, retourne  -1
        else if (this.nbMinerais - r.getCapaciteExtraction() < 0) { // S'il y moins de minerais dans la mine que la capacité d'extraction du robot
